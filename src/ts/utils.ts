import { CreateDOMElementParams, BrushSizeAction, BrushMode, BrushDOMElementsObject } from "./types/imageEditor.types";
 ...
 */
export const createDOMElement = <TagName extends keyof HTMLElementTagNameMap>(params: CreateDOMElementParams<TagName>): HTMLElementTagNameMap[TagName] => {
 ...
 */
export const removeToolActiveStates = (elements: NodeListOf<HTMLButtonElement>): void => {
 ...
 */
export const setActivePaintModeDOM = (brushElements: BrushDOMElementsObject, mode: BrushMode): void => {
